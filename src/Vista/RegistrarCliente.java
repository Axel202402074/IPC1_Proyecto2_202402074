...
public class RegistrarCliente extends javax.swing.JFrame {
   ...
   public RegistrarCliente() {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        ControladorRegistroCliente ctrl = ControladorRegistroCliente.getInstancia();
        if (ctrl.registrarCliente(dpi, nombre, usuario, contraseña, contraseña)) {
...
public String getDPI() { return txtDPI.getText(); }
    public String getNombre() { return txtNombre.getText(); }
    public String getUsuario() { return txtUsuario.getText(); }
    public String getPassword() { return new String(txtContraseña.getPassword()); }
